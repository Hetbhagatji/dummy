...
●	Develop and maintain server-side applications. Build scalable and secure web services using backend programming languages Python, Ruby, Java, and Node.js.
...
# STEP 2: Parse skills ONLY
skill_extractor = SkillExtractor()
skill_requirements = skill_extractor.parse(raw_data.raw_skills_text)
